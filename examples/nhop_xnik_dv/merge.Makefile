...
#HOST_ARGS :=  --filepath ./data-pair --hop 2 --batch 1024
HOST_ARGS :=  --filepath ./cit-Patents-twoHopPair1000 --hop 2 --limit 5 --numKernel 2 --batch 512
#HOST_ARGS :=  --filepath ./cit-Patents-twoHopPair --hop 2 --batch 512
#HOST_ARGS :=  --filepath ./cit-Patents-twoHopPair1000 --hop 2 --limit 4 --numKernel 3 --batch 512
#HOST_ARGS :=  --filepath ./data-pair --hop 2 --batch 1024

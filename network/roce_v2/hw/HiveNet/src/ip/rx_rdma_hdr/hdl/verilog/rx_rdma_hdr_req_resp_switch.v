...
always @ (*) begin
    ap_condition_244 = ((tmp_1_i_nbreadreq_fu_118_p3 == 1'd1) & (state == 1'd0) & (icmp_ln441_fu_269_p2 == 1'd0));
end
...
assign icmp_ln441_fu_269_p2 = ((tmp_payload_length_fu_237_p4 == 16'd0) ? 1'b1 : 1'b0);

    ...
    function [560:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "tx_rdma_hdr_tx_rdma_hdr.lshiftWordByOctet_512_0_U0";
                end
                1 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    case(index2)
                    1: begin
                        if (~lshiftWordByOctet_512_0_U0.axis_frame_ctx_to_hdr_gen_blk_n) begin
                        ...
                        if (~lshiftWordByOctet_512_0_U0.tx_to_hdr_gen_blk_n) begin
                ...
                1 : begin
                    ...
                    0: begin
                        if (~put_hdr_U0.tx_to_hdr_gen_blk_n) begin
                            if (~tx_to_hdr_gen_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'tx_rdma_hdr_tx_rdma_hdr.tx_to_hdr_gen_U' written by process 'tx_rdma_hdr_tx_rdma_hdr.lshiftWordByOctet_512_0_U0'");
                                $fdisplay(fp, "Dependence_Channel_path tx_rdma_hdr_tx_rdma_hdr.tx_to_hdr_gen_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~tx_to_hdr_gen_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'tx_rdma_hdr_tx_rdma_hdr.tx_to_hdr_gen_U' read by process 'tx_rdma_hdr_tx_rdma_hdr.lshiftWordByOctet_512_0_U0'");
                                $fdisplay(fp, "Dependence_Channel_path tx_rdma_hdr_tx_rdma_hdr.tx_to_hdr_gen_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~put_hdr_U0.axis_frame_ctx_to_hdr_gen_blk_n) begin
                            if (~axis_frame_ctx_to_hdr_gen_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'tx_rdma_hdr_tx_rdma_hdr.axis_frame_ctx_to_hdr_gen_U' written by process 'tx_rdma_hdr_tx_rdma_hdr.lshiftWordByOctet_512_0_U0'");
                                $fdisplay(fp, "Dependence_Channel_path tx_rdma_hdr_tx_rdma_hdr.axis_frame_ctx_to_hdr_gen_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~axis_frame_ctx_to_hdr_gen_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'tx_rdma_hdr_tx_rdma_hdr.axis_frame_ctx_to_hdr_gen_U' read by process 'tx_rdma_hdr_tx_rdma_hdr.lshiftWordByOctet_512_0_U0'");
                                $fdisplay(fp, "Dependence_Channel_path tx_rdma_hdr_tx_rdma_hdr.axis_frame_ctx_to_hdr_gen_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end

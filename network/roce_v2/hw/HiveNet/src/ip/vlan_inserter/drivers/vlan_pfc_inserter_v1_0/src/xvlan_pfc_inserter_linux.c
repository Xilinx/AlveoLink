...
typedef struct {
    ...
    XVlan_pfc_inserter_uio_map maps[ MAX_UIO_MAPS ];
} XVlan_pfc_inserter_uio_info;

/***************** Variable Definitions **************************************/
static XVlan_pfc_inserter_uio_info uio_info;
...
static int uio_info_read_name(XVlan_pfc_inserter_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XVlan_pfc_inserter_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XVlan_pfc_inserter_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XVlan_pfc_inserter_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XVlan_pfc_inserter_Initialize(XVlan_pfc_inserter *InstancePtr, const char* InstanceName) {
	XVlan_pfc_inserter_uio_info *InfoPtr = &uio_info;
